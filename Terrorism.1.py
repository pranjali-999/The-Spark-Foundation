...
# ![Blue%20and%20White%20Minimalist%20Welcome%20To%20My%20Page%20Facebook%20Fundraiser%20Cover%20Photo%20%283%29.png](attachment:Blue%20and%20White%20Minimalist%20Welcome%20To%20My%20Page%20Facebook%20Fundraiser%20Cover%20Photo%20%283%29.png)
...
# 2. As a Security Analyst, try to find out the hot zone of terrorism.
# 3. What all security issues and Insights you can derive by EDA?

# # Perform Exploratory Data Analysis on dataset : "Terrorsim"
...
sns.barplot(x=df['city'].value_counts().nsmallest(10).values, y=df['city'].value_counts().nsmallest(10).index, palette='magma')
plt.xlabel('Count')
plt.ylabel('City')
